<template>
  <div class="swiper-certify">
    <ul class="swiper-certif-list" @mouseenter="onMouseEnter" @mouseleave="onMouseLeave">
      <li v-for="(item,index) in swiperOption.imgs" :key="index" :class="classRender[index] || leftHide" @click="slideClick(classRender[index])" class="YcenterPosition">
        <!-- <img :src="item" /> -->
        <div :style="{ background: `url(${item}) center center / cover` }"></div>
      </li>
    </ul>
  </div>
</template>
